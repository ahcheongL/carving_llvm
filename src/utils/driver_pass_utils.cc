...
void get_driver_func_callees() {
  __inputf_modifier = Mod->getOrInsertFunction(
      "__driver_input_argv_modifier", VoidTy, Int8PtrTy, Int8PtrPtrPtrTy);
  __inputf_open =
      Mod->getOrInsertFunction("__driver_inputf_open", VoidTy, Int8PtrTy);

  replay_char_func = Mod->getOrInsertFunction("Replay_char", Int8Ty);
  replay_short_func = Mod->getOrInsertFunction("Replay_short", Int16Ty);
  replay_int_func = Mod->getOrInsertFunction("Replay_int", Int32Ty);
  replay_long_func = Mod->getOrInsertFunction("Replay_longtype", Int64Ty);
  replay_longlong_func = Mod->getOrInsertFunction("Replay_longlong", Int128Ty);
  replay_float_func = Mod->getOrInsertFunction("Replay_float", FloatTy);
  replay_double_func = Mod->getOrInsertFunction("Replay_double", DoubleTy);
  replay_ptr_func = Mod->getOrInsertFunction("Replay_pointer", Int8PtrTy,
                                             Int32Ty, Int32Ty, Int8PtrTy);

  replay_func_ptr = Mod->getOrInsertFunction("Replay_func_ptr", Int8PtrTy);
  ...
  update_class_ptr = Mod->getOrInsertFunction("__update_class_ptr", Int8PtrTy,
                                              Int8PtrTy, Int32Ty, Int32Ty);

  __replay_fini = Mod->getOrInsertFunction("__replay_fini", VoidTy);

  global_cur_class_index =
      Mod->getOrInsertGlobal("__replay_cur_class_index", Int32Ty);
  global_cur_class_size =
      Mod->getOrInsertGlobal("__replay_cur_pointee_size", Int32Ty);
  global_ptr_alloc_size =
      Mod->getOrInsertGlobal("__replay_cur_alloc_size", Int32Ty);
  global_cur_zero_address =
      Mod->getOrInsertGlobal("__replay_cur_zero_address", Int8PtrTy);
}