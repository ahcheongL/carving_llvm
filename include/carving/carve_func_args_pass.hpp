...
class CarverFAPass : public llvm::ModulePass {
 public:
  static char ID;
  CarverFAPass();
 ...
 private:
  ...
  void insert_carve_probe_fa(llvm::Value *val);

  void insert_gep_carve_probe_fa(llvm::Value *gep_val);
  void insert_array_carve_probe_fa(llvm::Value *val);
  void insert_struct_carve_probe_fa(llvm::Value *val, llvm::Type *ty);
  void insert_struct_carve_probe_fa_inner(llvm::Value *val, llvm::Type *ty);

  void gen_class_carver_fa();
